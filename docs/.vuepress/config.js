module.exports = {
  title: 'Vue Storefront 2 for myshop',
  base: '/',
  description: 'Documentation for the myshop connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/myshop',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/myshop'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/myshop'}
    ],
    sidebar: [
      {
        title: 'Essentials',
